...
# Paths to dataset
dataset_path = r"C:\Users\urvis\OneDrive\Desktop\AIML_EL\backup\DATASET"  # Replace with your dataset path
train_dir = os.path.join(dataset_path, r"C:\Users\urvis\OneDrive\Desktop\AIML_EL\backup\DATASET\TRAIN")  # TRAIN folder path
test_dir = os.path.join(dataset_path, r"C:\Users\urvis\OneDrive\Desktop\AIML_EL\backup\DATASET\TEST")    # TEST folder path
...
pretrained_model_path = r"C:\Users\urvis\OneDrive\Desktop\TrashNet-master\TrashNet-master\trained_model.h5"  # Replace with the path to your pre-trained model
try:
